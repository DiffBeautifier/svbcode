...
class GaussianDiffusion(nn.Module):
    def __init__(self, out_dims, denoise_fn,
        ...
        self.register_buffer('spec_min', torch.FloatTensor(spec_min)[None, None, :args.keep_bins])
        self.register_buffer('spec_max', torch.FloatTensor(spec_max)[None, None, :args.keep_bins])
    ...
    #逆采样
    @torch.no_grad()
    def p_sample(self, x_t, t, cond, spk_emb=None, clip_denoised=True, repeat_noise=False):  #这里的t是一个数
        # t=t.reshape(-1,1)
